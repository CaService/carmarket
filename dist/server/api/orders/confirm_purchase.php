...
-----END RSA PRIVATE KEY-----'; // Chiave privata DKIM
    ...
    <body>
        <div class='banner'>
            <img src='https://carmarket-ayvens.com/public_html/images/logo-desktop-ayvens-white.png' alt='Ayvens' style='max-width: 200px; height: auto; display: block; margin: 0 auto;'>
        </div>
        <div class='container'>
            <div class='header'>
