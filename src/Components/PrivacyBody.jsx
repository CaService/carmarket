    ...
    <>
      ...
      <Container>
        <div className="mt-[100px] pt-16">
          <h2 className="font-chillax font-medium text-gray-700 text-4xl">
            Informativa privacy Ayvens Italia
          </h2>
          <p className="text-gray-700 text-2xl font-bold w-2/3 pt-8">
            Ultimo aggiornamento: 13-01-2025
          </p>
          <p className="text-gray-700 text-2xl font-medium w-2/3 pt-8">
          ...
          <div className="w-[800px] pt-8 cursor-pointer">
            <a
          ...
          <h2 className="font-chillax font-medium text-gray-700 text-5xl pt-8">
            INDICE
          </h2>
          <ol className="list-decimal list-inside text-gray-700 text-lg font-regular w-2/3 pt-8">
          ...
          <h2 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
            <span>1. </span>
            Ambito di applicazione della presente Informativa
          </h2>
          <ol className="list-decimal text-gray-700 text-lg font-regular w-2/3 pt-8 ml-4">
            <li className="pt-4">
              <p>
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            Raccogliamo e utilizziamo i Dati personali dell&apos;utente
            attraverso i nostri vari servizi di leasing di veicoli e
            autovetture, di gestione della flotta aziendale e mobilità dei
            conducenti e nel corso dello svolgimento delle nostre attività
            commerciali (&quot;
            <span className="font-bold">Servizi</span>
            &quot;).
          </p>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            Determinati servizi potrebbero essere soggetti a un&apos;informativa
            sulla privacy separata, a cui si fa riferimento nei rispettivi
            termini.
          </p>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            <p className="font-bold">RESPONSABILITÀ DEI CLIENTI</p>
            Nella misura in cui i Clienti, in qualità di datori di lavoro, hanno
            accesso ai Dati personali dei loro dipendenti, ovvero i Conducenti,
            sono anche responsabili del trattamento e dell&apos;utilizzo dei
            suddetti dati in tale ruolo. La presente Informativa non si applica
            al trattamento e all&apos;utilizzo dei Dati personali dei Conducenti
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            L&apos;entità locale Ayvens è il Titolare del trattamento, ossia è
            responsabile del trattamento dei dati forniti dall&apos;utente.
            Indirizzo: ALD Automotive Italia srl, società con socio unico e sede
            legale a Roma, V.le Luca Gaurico 187
          </p>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            Ayvens può anche essere indicata come &quot;
            <span className="font-bold">noi</span>
            &quot;, &quot;
            <span className="font-bold">nostro</span>
            &quot; o &quot;
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            Noi e i nostri fornitori di servizi raccogliamo Dati personali nel
            modo seguente:
          </p>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            <p className="font-bold">Attraverso attività di vendita</p>
            Iniziamo il trattamento dei Dati personali se l&paos;utente li
            fornisce, direttamente o indirettamente tramite terze parti, ad
            esempio nell&apos;ambito di una vendita offline, di una
            registrazione, di un modulo di contatto online, di una richiesta via
            e-mail, al telefono, in chat e/o in un&apos;applicazione, di un
            sondaggio o di un concorso a premi.
          </p>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            <p className="font-bold">Attraverso i Servizi</p>
            La maggior parte dei Dati personali che raccogliamo sono in
            relazione ai Servizi che forniamo o forniremo all&apos;utente in
            qualità di (i) Conducente e nostro Cliente, il suo datore di lavoro,
            se utilizza un veicolo aziendale, o (ii) Cliente di leasing privato.
            Tutto inizia con la registrazione dei Dati personali in relazione al
            veicolo da prendere in leasing (in alcune circostanze potremmo
            effettuare dei controlli preliminari sulla solvibilità prima del
            leasing) e continua con la registrazione del veicolo in leasing e
            quando comunichiamo con l&apos;utente in merito ai nostri Servizi,
            ad esempio per organizzare manutenzione e riparazioni periodiche.
            Potremmo inoltre elaborare i Dati personali dell&apos;utente quando
            il veicolo è inavvertitamente coinvolto in un incidente, per
            garantire il ripristino della mobilità e la gestione di eventuali
            danni, o quando siamo i destinatari di multe stradali in relazione
            al veicolo in leasing. Oltre alle nostre principali attività di
            leasing, forniamo anche una serie di altri servizi correlati, come
            servizi di mobilità elettrica, servizi di carte carburante, servizi
            di ricarica, servizi di noleggio auto e assistenza stradale. Un
            altro servizio che forniamo riguarda il car remarketing, la vendita
            di veicoli Ayvens usati.
          </p>
          <h2 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
            4. Perchè e su quale base giuridica utilizziamo i dati personali?
          </h2>
          {/* DATI RELATIVI AI VISITATORI DEL SITO WEB*/}
          <h3 className="w-2/3 font-chillax font-medium text-gray-700 text-2xl pt-8">
            4.1 DATI RELATIVI AI VISITATORI DEL SITO WEB
          </h3>
            ...
            <Accordion title="4.2.1 GESTIONE DELL'ACCOUNT DEL CLIENTE">
              <div>
                ...
                <p className="mb-4">
                  ...
                  sull&apos;esecuzione del Cliente. Questo trattamento si basa
                ...
                <p className="mb-4">
                  ...
                  legittimo interesse, potremmo inviare all&apos;utente, ad
                  esempio, comunicazioni di marketing per tenerlo aggiornato su
                  marketing per tenerlo aggiornato su eventi, offerte attuali o
                  future, promozioni e prodotti e servizi attuali e futuri di
                  Ayvens. Invieremo all&apos;utente tali sondaggi sotto forma di
                  e-mail periodiche o un&apos;e-mail per richiedere il suo
                  feedback sui nostri Servizi e su altri servizi svolti sul
                  veicolo. Potremmo anche inviare all&apos;utente comunicazioni
                  postali (newsletter/opuscoli/riviste). Per rilevante per
                  l&apos;utente, possiamo utilizzare vari strumenti per
                  analizzare le sue informazioni personali. Se non desidera più
                  ricevere sondaggi o comunicazioni di marketing da parte
                  nostra, l&apos;utente è pregato di revocare il suo consenso o
                  contattarci tramite il modulo sul sito web dell&apos;entità
                  locale Ayvens o tramite le informazioni di contattarci tramite
                  il modulo sul sito web dell&apos;entità locale Ayvens o
                  tramite le informazioni di contatto indicate di seguito.
                </p>
                <p className="mb-4">
                  Per agevolare l&apos;utilizzo dei nostri Servizi o
                  applicazioni online da parte dell&apos;utente, potremmo
                ...
                <p className="mb-4">
                  Per conseguire questa finalità, potremmo trattare nome e
                  cognome e informazioni aziendali di contatto dell&apos;utente.
                </p>
          ...
          <h4 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
          ...
          <ul className="list-disc w-2/3 ml-4">
            <li>
              ...
              <p className="mt-8 text-gray-700 text-lg font-medium">
                ...
                utilizzano i Dati personali, scegli la bandiera dello stato nel
                menù in alto a destra del sito www.Ayvens.com.
              </p>
            </li>
            <li>
              <p className="mt-8 text-gray-700 text-lg font-medium">
                Nell&apos;ambito del Gruppo Société Générale a cui appartiene
                Ayvens, per finalità amministrative interne, per adempiere a un
                obbligo legale, per migliorare i nostri servizi, per consentirci
                di rispettare in modo più efficiente ed efficace leggi e
                regolamenti o per finalità di monitoraggio, controllo e
                reporting. Le finalità di reporting riguardano eventuali
                obblighi normativi e statutari di reporting e richieste di dati
                come stabilito dalle autorità di regolamentazione del Gruppo
                Société Générale.
              </p>
            </li>
            <li>
              <p className="mt-8 text-gray-700 text-lg font-medium">
                ...
                partner non affiliati, o partner commerciali quali produttori di
                apparecchiature originali (OEM) e intermediari, per agevolare i
                servizi forniti all&apos;utente e a noi.
              </p>
            </li>
          </ul>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            ...
            partner non affiliati. I partner di servizi indipendenti ci aiutano
            a fornire all&apos;utente i nostri servizi di leasing e di altra
            natura e comprendono concessionari, fornitori di servizi di
            comprendono concessionari, fornitori di servizi di manutenzione,
            carrozzerie e fornitori di assistenza stradale, ma anche società di
            noleggio e amministratori dei nostri programmi di sicurezza per i
            conducenti. I concessionari o i fornitori di veicoli (elettrici)
            potrebbero richiedere i dati di contatto di un conducente per
            attivare un account personale, necessario per la configurazione come
            conducente, altrimenti il veicolo non potrà funzionare. I fornitori
            di servizi sono aziende a cui ci affidiamo per aiutarci nella
            gestione delle nostre attività, ad esempio per mantenere la nostra
            rete informatica e la relativa infrastruttura nonché per svolgere i
            controlli di sicurezza e di accesso nei nostri locali.
          </p>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            Inoltre, utilizziamo e divulghiamo i Dati personali dell&apos;utente
            se necessario o appropriato, in particolare quando abbiamo un
            obbligo legale o un legittimo interesse a farlo:
          </p>
          <ul className="list-disc w-2/3 ml-4">
            <li>
              <p className="mt-8 text-gray-700 text-lg font-medium">
            ...
            <li>
              ...
              <p className="mt-8 text-gray-700 text-lg font-medium">
                ...
                riteniamo importanti. Sono potenzialmente incluse le autorità al
                di fuori del Paese di residenza dell&apos;utente.
              </p>
            </li>
            <li>
              <p className="mt-8 text-gray-700 text-lg font-medium">
            ...
            <li>
              ...
              <p className="mt-8 text-gray-700 text-lg font-medium">
                ...
                dell&apos;attività, dei beni o delle azioni di Ayvens (anche in
                relazione a una procedura fallimentare o simile). Tali terze
                parti possono includere, ad esempio, un&apos; entità acquirente
                e i suoi consulenti.
              </p>
            </li>
          </ul>
          ...
          <h3 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
            6. Perchè i dati personali possono essere trasferiti a paesi terzi?
          </h3>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            Ayvens è un fornitore di servizi globale con clienti e sedi in tutto
            il mondo. I Dati personali dell&apos;utente possono essere
            ...
            che utilizzano i Dati personali, scegli la bandiera dello stato nel
            menù in alto a destra del sito{" "}
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            ...
            contattandoci all&apos;indirizzo riportato nella successiva sezione
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            I nostri servizi non sono rivolti a individui di età inferiore a 18
            anni.
          </p>
          <h3 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            Potremmo utilizzare i Dati personali dell&apos;utente anche per una
            finalità diversa da quella iniziale. Ciò è consentito a condizione
            che la finalità secondaria sia in linea con la finalità iniziale.
            Vengono presi in considerazione, tra gli altri, i seguenti fattori:
            le finalità sono chiaramente correlate; la finalità secondaria è
            appropriata e/o prevista; i Dati personali sono stati ottenuti
            direttamente dall&apos;utente o in altro modo; che tipo di Dati
            personali sono interessati dalla finalità secondaria; quali
            sarebbero le implicazioni per l&apos;utente; e quali misure di
            protezione dei dati vengono applicate quando i dati dell&apos;utente
            vengono applicate quando i dati dell&apos;utente sono utilizzati per
            le finalità secondarie.
          </p>
          <h3 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
            9. Per quanto tempo conserveremo i dati dell&apos;utente?
          </h3>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            I Dati personali degli interessati saranno conservati per il periodo
            necessario a soddisfare le finalità descritte nella presente
            Informativa, a meno che non sia richiesto o consentito dalla legge
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            ...
            l&apos;utente utilizza o prende in leasing un veicolo Ayvens); come
            previsto da un obbligo legale a cui siamo soggetti; e come
            consigliabile alla luce della nostra posizione legale, ad esempio
            per termini di prescrizione applicabili, le controversie legali o le
            indagini normative. Trascorso il periodo di conservazione
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            ...
            dei dati. Purtroppo, nessun sistema di trasmissione o archiviazione
            dei dati può garantire una sicurezza del 100%. Se l&apos;utente ha
            motivo di ritenere che la propria interazione con noi non sia più
            sicura, è pregato di segnalarcelo immediatamente in conformità alle
            istruzioni riportate nella successiva sezione &quot;Come è possibile
            contattarci&quot;.
          </p>
          <h3 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
          ...
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8">
            ...
            qualsiasi momento, ad esempio, per adattarla agli sviluppi futuri di
            Ayvens o ai cambiamenti nelle tendenze settoriali o legislative. La
            dicitura &quot;Ultimo aggiornamento&quot; all&apos;inizio della
            presente Informativa indica la data della sua revisione più recente.
          </p>
          <h3 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
          ...
          <h3 className="w-2/3 font-chillax font-medium text-gray-700 text-4xl pt-8">
            13. Come è possibile esercitare i propri diritti sui dati personali?
          </h3>
          <p className="text-gray-700 text-lg font-medium w-2/3 pt-8 pb-32">
            L&apos;utente è pregato di contattare il nostro Responsabile della
            protezione dei dati all&apos;indirizzo{" "}
            <span className="text-teal-700 underline">
              dpoalditalia@aldautomotive.com
            </span>{" "}
            se dovesse avere domande o dubbi sulle modalità attraverso le quali
            Ayvens elabora i suoi Dati personali; se desidera esercitare il suo
            diritto di richiedere l&apos;accesso, la correzione, la
            ...
            copia o la portabilità dei propri Dati personali. Risponderemo alla
            richiesta inoltrata in conformità alla legge in vigore.
            L&apos;utente deve tenere presente che potremmo non essere tenuti a
            soddisfare (o soddisfare pienamente) la sua richiesta. Le leggi o i
            regolamenti in vigore possono imporre condizioni o limitare alcuni
            di tali diritti. condizioni o limitare alcuni di tali diritti. Ad
            esempio, per tutto il tempo in cui abbiamo in corso un rapporto o
            quando i Dati personali sono conservati in un sistema di backup
            (allo scopo di ripristinarli in caso di perdita di dati) e il ciclo
            di eliminazione dei dati potrebbe essere diverso da quello
            applicabile al sistema di produzione. In tali circostanze,
            ...
            evasa in una fase successiva (quando il backup viene sovrascritto).
            Si prega di specificare chiaramente, nella richiesta inoltrata, a
            quali Dati personali si vuole accedere o modificare o eliminare,
            oppure di comunicarci quali limitazioni si vorrebbero applicare al
            nostro utilizzo dei Dati personali. Per la tutela dell&apos;utente,
            evadiamo richieste solo in relazione alle informazioni associate
            all&apos;indirizzo e-mail specifico utilizzato per inviarci tali
            richieste e potremmo richiedere ulteriori informazioni per
            verificare l&apos;identità del mittente prima di procedere. Tenere
            presente che alcuni Dati personali potrebbero essere esenti da tali
            obblighi ai sensi delle leggi vigenti sulla protezione dei dati o di
            altre leggi e regolamenti. L&apos;utente può anche presentare un
            reclamo all&apos;autorità di protezione dei dati del proprio Paese o
            regione, oppure del luogo in cui si è verificata la presunta
            violazione. Qui è disponibile il{" "}
            <a
            ...
            alle autorità nazionali per la dati situate nell&apos;Unione europea
