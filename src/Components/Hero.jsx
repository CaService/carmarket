  ...
  return (
    <>
      <div className="z-10 relative pt-18">
        <h1 className="absolute top-[30%] md:top-[40%] left-1/2 md:left-[8%] -translate-x-1/2 md:translate-x-0 font-medium text-[#0A2A3B] text-[32px] md:text-[clamp(30px,3.2vw,48px)] leading-tight font-chillax w-[90%] md:w-auto text-center md:text-left">
